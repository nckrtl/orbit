...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement(<<<'SQL'
            ...
            WHEN (
                ...
                OR (NEW.status = 'active' AND NEW.failed_step IS NOT NULL AND NEW.replacement_step IS NULL)
    ...
    {
        throw new RuntimeException('Active Route replacement failure evidence cannot roll back.');
    }
};

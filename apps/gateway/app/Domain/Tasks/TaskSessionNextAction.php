...
enum TaskSessionNextAction: string
{
    ...
    public static function choiceCriteria(): array
    {
        return [
            ...
            self::ContinueImplementer->value => 'The implementer is idle with unfinished work on the current brief.',
            self::RelayReviewToImplementer->value => 'The reviewer left a summary and the implementer is idle.',
            self::MarkSubtaskDone->value => 'The current subtask is verified and should settle or hand off to review.',

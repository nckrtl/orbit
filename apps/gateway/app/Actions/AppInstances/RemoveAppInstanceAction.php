            ...
            function () use ($appInstance, $discardSource): AppInstance {
                ...
                if ($snapshot->source_kind !== AppInstanceSourceKind::ManagedClone->value) {
                    throw new ResourceOperationException(
                        ...
                        message: $snapshot->source_kind === AppInstanceSourceKind::RegisteredWorktree->value
                            ? "AppInstance [{$snapshot->name}] is a registered worktree; use instance:unregister."
                            : "AppInstance [{$snapshot->name}] is not an Orbit-managed clone.",
                        status: 409,
                    );
                }

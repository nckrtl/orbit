...
it('renders a systemd unit that binds the WireGuard DNS address to the published catalog', function (): void {
    ...
    expect($unit)
        ...
        ->toContain('"/usr/bin/php8.5" "/home/orbit/orbit-gateway/artisan" "orbit:private-dns-serve" "--listen=10.44.0.1" "--port=53" "--catalog=/var/lib/orbit/private-dns/catalog.json" "--upstream=127.0.0.55:53"')

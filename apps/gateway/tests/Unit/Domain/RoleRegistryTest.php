...
describe(RoleRegistry::class, function (): void {
    ...
    it('keeps gateway and application ownership models apart', function (): void {
        ...
        expect($registry->conflicts(RoleName::Gateway, RoleName::AppDev))
            ...
            ->toBeTrue()
            ->and($registry->conflicts(RoleName::Gateway, RoleName::Ingress))
            ->toBeTrue()
            ->and($registry->conflicts(RoleName::Ingress, RoleName::Gateway))
            ->toBeTrue()
            ...
            ->toBeFalse()
            ->and($registry->conflicts(RoleName::Router, RoleName::Database))
            ->toBeFalse()

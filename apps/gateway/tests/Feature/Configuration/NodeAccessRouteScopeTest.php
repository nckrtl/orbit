...
it('declares node access scope on every active-peer API route', function (): void {
    ...
    $expectedScopes = [
        ...
        'tasks:subtask:create' => ServingNode::Gateway,
        'tasks:subtask:destroy' => ServingNode::Gateway,
        'tasks:subtask:update' => ServingNode::Gateway,
        'tasks:update' => ServingNode::Gateway,

...
it('declares node access scope on every active-peer API route', function (): void {
    ...
    $expectedScopes = [
        ...
        'cluster:new' => ServingNode::Gateway,
        'cluster:node:attach' => ServingNode::Target,
        'cluster:node:detach' => ServingNode::Target,
        'cluster:remove' => ServingNode::ClusterOwning,
        'cluster:router:clear' => ServingNode::ClusterOwning,
        ...
        'database-connection:update' => ServingNode::Gateway,
        ...
        'herdr:session:add' => ServingNode::HerdrSessionOwning,
        'herdr:session:list' => ServingNode::HerdrSessionOwning,
        'herdr:session:remove' => ServingNode::HerdrSessionOwning,
        ...
        'instance:deployment:store' => ServingNode::InstanceOwning,
        ...
        'instance:rollback:store' => ServingNode::InstanceOwning,
        ...
        'schedule:activate' => ServingNode::ScheduleOwning,
        'schedule:add' => ServingNode::ScheduleOwning,
        'schedule:complete' => ServingNode::ScheduleHost,
        'schedule:list' => ServingNode::Collection,
        'schedule:logs' => ServingNode::ScheduleOwning,
        'schedule:remove' => ServingNode::ScheduleOwning,

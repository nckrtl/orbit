...
it('projects instances and networks to their stable identity fields', function (): void {
    $instances = [
        [
            ...
            'expanded_devices' => ['eth0' => ['type' => 'nic', 'network' => 'oe-standby']],
    ...
    $networks = [
        [
            ...
            'used_by' => ['/1.0/instances/orbit-e2e-standby-gateway'],
        ],
    ...
    expect(LiveInventory::fingerprint($instances, $networks))->toBe([
        'instances' => [
            'orbit-e2e-standby-gateway' => [
                ...
                'devices' => ['eth0' => ['type' => 'nic', 'network' => 'oe-standby']],
            ],
        ],
        'networks' => [
            'lo' => ['type' => 'loopback', 'managed' => false, 'config' => []],
            'oe-standby' => ['type' => 'bridge', 'managed' => true, 'config' => ['ipv4.address' => '10.232.0.1/24']],
        ],
    ]);
});
...
it('names the resources of one attempt exactly', function (): void {
    $names = LiveInventory::observedNames(
        ...
        [['name' => 'oe-aaaaaaaaaaaa'], ['name' => 'oe-standby']],

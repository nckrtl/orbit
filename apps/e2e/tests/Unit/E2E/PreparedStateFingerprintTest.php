    ...
    it('tracks the prepared guest dependency closure without lifecycle-only orchestration', function (): void {
        ...
        expect($paths)
            ...
            ->toContain(
                ...
                'apps/cli/app/Commands/Clusters/AddClusterNodeCommand.php',
                ...
                'apps/cli/app/Commands/Environment/SynchronizeEnvironmentCommand.php',
                ...
                'apps/gateway/app/Infrastructure/AppInstances/RemoteProductionAppInstanceSourceLifecycle.php',
                'apps/gateway/app/Domain/AppInstances/Environment/AppInstanceEnvironmentContextResolver.php',
                'apps/gateway/app/Domain/AppInstances/Environment/AppInstanceEnvironmentWriter.php',
                ...
                'packages/php-sdk/src/Requests/Clusters/AddClusterNodeRequest.php',

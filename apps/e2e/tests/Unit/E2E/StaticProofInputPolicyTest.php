...
describe('StaticProofInputPolicy', function (): void {
    it('classifies the phase-one repository boundaries explicitly', function (string $path, string $expected): void {
        ...
        'CLI PHAR box configuration' => ['apps/cli/box.json', 'non-runtime'],
        'CLI PHPacker manifest' => ['apps/cli/phpacker/composer.json', 'non-runtime'],
        'CLI PHPacker lock' => ['apps/cli/phpacker/composer.lock', 'non-runtime'],

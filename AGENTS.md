...
For focused documentation work, use [writing-documentation](.agents/skills/writing-documentation/SKILL.md). For real terminal recordings, use [verifying-cli-output](.agents/skills/verifying-cli-output/SKILL.md). Project guidance supplies coding and testing conventions.

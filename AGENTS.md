...
- Developers run affected Pest tests through TIA and the changed project's checks, then the
  ...
  0059 requires.
- Use `bin/test` only for an explicit repository-wide TIA run or failure diagnosis.

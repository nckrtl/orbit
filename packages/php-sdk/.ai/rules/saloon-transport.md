...
- Review matching repository SDK requests, responses, exceptions, correlation,
  and fake tests before you invent transport behavior. Reuse proven transport
  invariants. The current Gateway design, not a retired package, is the surface
  authority.

...
- Keep AppInstance transport limited to App, Node, name, optional root, optional
  Route hostname, optional creation branch, explicit removal force intent, and
  bounded removal progress. Do not expose the retired discard compatibility name.

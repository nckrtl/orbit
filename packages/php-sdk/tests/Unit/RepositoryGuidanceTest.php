...
describe('repository guidance bootstrap', function (): void {
    ...
    it('documents the 126-operation SDK surface including Database connection transport', function (): void {
        ...
        expect($publicContract)
            ->toContain('The SDK models exactly 126 concrete public Gateway API operations:')
            ->toContain(
                '- Node: list, show, add, settings update, remove, access add, access remove, role list, role add, role relocate, role remove, and metrics.',
            )
            ->toContain(
        ...
        expect(repository_guidance_normalized_contents('README.md'))
            ->toContain(
                'The SDK exposes exactly 126 public Gateway operations.',

...
describe('repository guidance bootstrap', function (): void {
    ...
    it('documents the 123-operation SDK surface including Database connection transport', function (): void {
        ...
        expect($publicContract)
            ->toContain('The SDK models exactly 123 concrete public Gateway API operations:')
            ->toContain(
        ...
        expect(repository_guidance_normalized_contents('README.md'))
            ->toContain(
                'The SDK exposes exactly 123 public Gateway operations.',

...
- Detail: <the docs/reference page that describes the mechanism once it ships, written as a path rather than a link while the page does not exist yet; or none>

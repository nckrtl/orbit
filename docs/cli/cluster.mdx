...
The [Routes reference](/reference/routes) owns hostname generation, routing scope, and Router transition ownership. [Private DNS](/reference/private-dns#cluster-router-addresses) owns which Router address a requester receives.

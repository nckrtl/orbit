---
title: "database"
description: "Register, inspect, update, and destroy the mysql, pgsql, sqlite, and redis connections that App instances can attach, and create a MySQL user through a Node Process."
---

...
- **Analytics driver** — The Gateway contract that reads visits for an App instance from the fleet analytics service. The first driver calls the Plausible Community Edition Stats API. See [App instance analytics stats](/reference/instance-analytics-stats).

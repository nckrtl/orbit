...
- **Runtime hibernation** — The Gateway stops idle development AppInstance Processes and wakes them on the next HTTP request. See [App-dev runtime hibernation](reference/app-dev-runtime-hibernation.md) and [ADR 0074](decisions/0074-hibernate-idle-app-dev-appinstance-processes.md).

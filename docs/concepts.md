...
- **Database connection** — Saved credentials an App instance can attach. The Gateway can create a MySQL user through a Node Process. See [Database connections](/reference/database-connections).

...
- **App** — Orbit's application record with one repository identity, `default_branch` setting, and relative web root. Each AppInstance inherits the root. Its branch follows explicit input, a matching name, or the default. See [Apps](reference/apps.md).

...
- [Decisions](decisions/README.md) keeps the history behind important design
  choices.
- Product reference pages describe [Apps](reference/apps.md), [AppInstance removal](reference/appinstance-removal.md), [Gateway trust](reference/gateway-trust.md), the [Metrics role](reference/metrics.md), [Node retarget](reference/node-retarget.md), [PHP runtime defaults](reference/php-runtime.md), [Routes](reference/routes.md), [Tools](reference/tools.md), and [WireGuard endpoints](reference/wireguard-endpoints.md).

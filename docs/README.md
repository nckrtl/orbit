...
- Application reference pages describe [Apps](/reference/apps), [App instance cloning](/reference/appinstance-cloning), [App instance transfer](/reference/appinstance-transfer), [App instance environment variables](/reference/environment-variables), [App process and Schedule definitions and copies](/reference/app-processes-and-schedules), and [App instance removal](/reference/appinstance-removal).

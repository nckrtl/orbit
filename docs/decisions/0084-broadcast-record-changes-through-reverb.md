...
- ADRs: builds on [ADR 0080](/decisions/0080-add-node-owned-custom-proxy-routes) for the WebSocket-capable Route Reverb runs behind; depended on by [ADR 0085](/decisions/0085-build-orbit-top-as-a-thin-tui-client)

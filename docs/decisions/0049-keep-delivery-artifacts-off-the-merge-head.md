...
Accepted on 2026-09-10. Extends [ADR 0015](/decisions/0015-retain-incus-proof-by-recorded-input-equivalence). Supersedes [ADR 0022](/decisions/0022-track-the-issue-workspace-and-delete-it-before-merge) for branch storage, removal, and second approval.
...
- Components: apps/e2e
- ADRs: extends [ADR 0015](/decisions/0015-retain-incus-proof-by-recorded-input-equivalence); supersedes [ADR 0022](/decisions/0022-track-the-issue-workspace-and-delete-it-before-merge) for branch storage, removal, and second approval

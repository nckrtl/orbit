...
| Destroy | Clear the site publication, publish DNS and Caddy without it, then remove the Orbit CA leaf. A failure before the certificate step keeps the leaf; destroy again to retry. Instance Routes stay unchanged. |

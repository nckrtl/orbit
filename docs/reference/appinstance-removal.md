...
Registration transfers an adopted checkout or worktree into AppInstance ownership. Orbit removes that source through `instance:destroy`; it exposes no separate unregister command or lifecycle.

...
Metrics reconvergence and removal change the stored Metrics publication and then [build the Gateway Node's Caddyfile](/reference/caddy-configuration). The build keeps every other site on that Node.

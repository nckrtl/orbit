...
`GET /api/v1/instances/{instance}/analytics/stats` returns one report. The Orbit web Instance page shows it. The CLI and the PHP SDK have no counterpart for this read.

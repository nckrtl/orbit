...
echo "$refused" | grep -q '"error"' || fail "metrics node exporter could be disabled: $refused"
echo "exporter-disable: app-prod removed from targets; metrics node exporter refused"

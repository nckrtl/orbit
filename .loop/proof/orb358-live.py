...
CANDIDATE = 'db54cd60949aedf0ba57b5f12c3ea54555693cf9'
...
if args.stage == 'prepare':
    ...
    record_pty('process-show-definition', ['process:show', 'ux358-def', f'--app={dev["app_id"]}'], contains=['ux358-def', '/bin/true'])
    record_pty(
        'process-update-definition',
        ['process:update', 'ux358-def', f'--app={dev["app_id"]}', '--for=development', '--command=/bin/false'],
        contains=['ux358-def', '/bin/false'],
    )

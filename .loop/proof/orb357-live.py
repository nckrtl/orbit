...
CANDIDATE = 'fc3bd5e3ff612e862b5d11a177cda8d8a7d37f98'
...
parser.add_argument('--stage', required=True, choices=[
    'prepare', 'registry', 'query-sqlite', 'inspect', 'mysql', 'attach', 'consent', 'env', 'native-visual', 'coverage-report',
])
...
def record_pty(label, argv, *, expected=0, contains=None, absent=None, error_code=None, actual_gateway=True, input_actions=None, columns=100, compact_contains=None, plain=False, rows=40):
    out = root / label
    out.mkdir()
...
if args.stage == 'prepare':
    ...
    expected = {
        'database:create': ['create-human'],
        'database:list': ['list-human', 'list-plain', 'list-pipe', 'list-json', 'native-list'],
        'database:show': ['show-human', 'show-unknown', 'mysql-show', 'native-show-mysql'],
        'database:update': ['update-human'],
        'database:query': ['query-empty-read', 'query-insert', 'query-select-write', 'query-truncated', 'query-write-required', 'mysql-query'],
        'database:tables': ['tables-human'],
        'database:schema': ['schema-human'],
        'database:describe': ['describe-human', 'describe-missing'],
        'database:user:create': ['mysql-user-create', 'mysql-user-missing-process'],
        'database:destroy': ['destroy-json-no-force', 'destroy-default-no', 'destroy-cancel', 'destroy-eof', 'destroy-pipe-no-force', 'destroy-force'],
        'instance:database:add': ['attach-add'],
        'instance:database:remove': ['attach-remove-json-no-force', 'attach-remove-default-no', 'attach-remove-force'],
        'env:update': ['env-update', 'env-update-json', 'env-update-pipe'],
        'env:import': ['env-import'],
        'env:sync': ['env-sync'],
    }
    found = {}
    missing = []

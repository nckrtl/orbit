...
parser.add_argument('--stage', choices=['prepare', 'reads', 'reads-narrow', 'source', 'invalid', 'mutation-modes', 'consent-automation', 'unpublished-source', 'signals-empty', 'clone-partial', 'pending-http', 'empty-list', 'native-visual', 'coverage-report'], required=True)
...
if args.stage == 'prepare':
    ...
    invalid_errors = [
        'instance-show-instance-id-invalid',
        'instance-create-app-id-invalid',
        'instance-clone-instance-candidate-id-invalid',
        'instance-clone-instance-preview-name-required',
        'instance-update-instance-id-invalid',
        'instance-destroy-instance-id-invalid',
        'instance-transfer-instance-id-invalid',
        'instance-deploy-step-list-instance-id-invalid',
        'instance-deploy-step-create-instance-id-invalid',
        'instance-release-list-instance-id-invalid',
        'instance-register-instance-source-invalid',
    ]
    invalid_cases = [name + suffix for name in invalid_errors for suffix in ['-human', '-json-tty', '-plain']] + ['instance-show-missing-json-tty']
    gateway_cases = {

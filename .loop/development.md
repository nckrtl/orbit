...
- Focused new tests: `33` passed, `168` assertions.
...
The exact-candidate root `composer check`, artifact publication, and pushed-head binding are recorded in the implementation handoff after the candidate commit.

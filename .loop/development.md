...
Flow: discovery. Incus: not required. Candidate: f44946512f8fbc44ce429e6a631acbcbb1594b32.
...
- First HTTP request after idle must not reach the app until desired-running Processes (and Vite on `127.0.0.1:5173` when present) are ready. Concurrent wake: HTML 401 progress. Failed wake: HTML 503 + retry.
...
- `tests/Feature/Domain/Hibernation/*` — policy, idle halt, wake readiness, leave desired-stopped stopped passed

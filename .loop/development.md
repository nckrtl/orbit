...
Candidate: `57fb84c023bb17932f29fe30cb1d8337617e7eca`
Flow: `discovery`
Incus: required
...
Result: 386 passed, 1,995 assertions.
...
- Acquired and retained discovery attempt `6f5b542748a3f7898514dd51a7c06530` from unchanged generation `7940b101271d-a565831a39de`, then synchronized it to corrected candidate `57fb84c023bb17932f29fe30cb1d8337617e7eca`.
- `bin/e2e-topology sync ORB-231 --worktree=/fast/worktrees/orbit/orb-231 --json` recorded clean host and guest source at the corrected candidate. `bin/e2e-topology verify ORB-231 --worktree=/fast/worktrees/orbit/orb-231 --json` passed. An app-dev `inspect-state` exited 0 with `shape: app_instances`, and the topology verifier observed one active AppInstance with one Route association.
